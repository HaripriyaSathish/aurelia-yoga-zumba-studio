            ...
            >
              <div className="relative h-80 overflow-hidden">
                ...
                <div className="absolute inset-x-0 bottom-0 p-5">
                  ...
                  <p className="text-xs text-[#FF9270] font-medium mt-0.5">{t.role}</p>
                  ...
                  <div className="mt-3 max-h-0 opacity-0 group-hover:max-h-40 group-hover:opacity-100 overflow-hidden transition-all duration-500">
                    ...
                    <div className="flex items-center gap-3">
                      {t.instagram_url && (
                        <a href={t.instagram_url} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full glass flex items-center justify-center hover:bg-[#FF6B4A] transition-colors">
                          <InstagramIcon className="w-4 h-4 text-white" />
                        </a>
                      )}
                      {t.facebook_url && (
                        <a href={t.facebook_url} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full glass flex items-center justify-center hover:bg-[#FF6B4A] transition-colors">
                          <FacebookIcon className="w-4 h-4 text-white" />
                        </a>
                      )}
                      {t.linkedin_url && (
                        <a href={t.linkedin_url} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full glass flex items-center justify-center hover:bg-[#FF6B4A] transition-colors">
